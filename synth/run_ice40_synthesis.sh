...
run_one shieldlink_modeB_flush top_fpga_modeB_flush rtl/shieldlink_ctrl_modeB_flush.sv rtl/top_fpga_modeB_flush.sv
run_one shieldlink_modeB_sr top_fpga_modeB_sr rtl/shieldlink_ctrl_modeB_sr.sv rtl/top_fpga_modeB_sr.sv
echo "iCE40 technology-mapped results are in $OUT_DIR"
