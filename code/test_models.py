#!/usr/bin/env python3
import unittest
from protocol_realism_experiments import LINK_BYTES_PER_CYCLE,WORKLOADS,run_mode_b,run_mode_a
...
class ModelTests(unittest.TestCase):
    ...
    def test_pipeline_hides_verification_but_not_serialization(self):
        ...
        self.assertLessEqual(four['throughput_payload_B_per_cycle'],LINK_BYTES_PER_CYCLE)
    def test_tag_attack_is_security_drop_not_goodput(self):
        ...
        self.assertEqual(r['security_drops'],20);self.assertEqual(r['delivery_ratio'],0);self.assertEqual(r['goodput'],0)
        self.assertGreater(r['offered_efficiency'],0)
